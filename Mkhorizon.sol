...
contract MkHorizon is Context, IERC20, Ownable {
    ...
    string private _name = "Mk-Horizon";      //CHANGE_REQUIRED: name of token
    string private _symbol = "GUMMI";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
